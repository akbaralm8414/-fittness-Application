...
AI-Powered Fitness Application is a full-stack microservices-based web application designed to help users manage fitness activities, track progress, and receive personalized AI-driven fitness recommendations.
The system is built using Spring Boot microservices architecture with secure authentication, service discovery, API gateway routing, asynchronous communication using Kafka, and AI integration using Google Gemini/OpenAI APIs.
...
2. Activity Service publishes event to Kafka
3. AI Service consumes activity data
4. AI generates personalized recommendations
5. Recommendations are sent back to users
...
**Akbar Alam**
Aspiring Java Full Stack & Backend Developer
